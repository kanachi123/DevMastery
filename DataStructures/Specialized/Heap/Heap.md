...
#### **обычно хип имплементируют через массивы,чем указателям,хотя кому не лень могут написать свой STL с кучей,я не стану,ибо есть алгоритмический подход,у меня нет столько времени,у нас еще другие папки кроме структур данных**
